  ...
  return (
    (props.pets.length > 0) && <section className='time' style={{backgroundColor: props.corSecundaria}}>
                                  <div className='input_cor'>
                                    <p>Mude de cor</p>
                                    <input  value={props.corPrimaria} onChange={evento=> props.mudarCor(evento.target.value, props.id)}  type="color" />
                                  </div>  
                                  ...
                                  <div className="pets">
                                    {props.pets.map(pet => {
                                      return <Pet corDeFundo={props.corPrimaria} pet={pet} key={pet.nome} nome={pet.nome} raca={pet.raca} imagem={pet.imagem} aoDeletar={props.aoDeletar}/>
                                    })}
                                  </div>  
                               </section>
